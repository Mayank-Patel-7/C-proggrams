...
int phone()
{
    ...
    printf("\npress the given code value to procced\n[1]-For APPLE\n[2]-For SAMSUNG\n[3]-For Vivo\n[4]-For Xiomi\n");
    scanf("%d", &choice);
...
int Headphone()
{
    ...
    case 3:
        ...
        break;
    case 4:
        printf("\nWe are having a specific model from MSI/n");
...
{
    int Bc,sel;
    printf("[1]BenQ EW3880R 38' (96 cm) WQHD+ Ultrawide 2300R Curved Monitor, IPS, Bezel-Less, HDR, 3840 x 1600 Pixels\nPrice(Including all inclusive taxes)- Rs 67,999/-Only\n\n[2]BenQ MOBIUZ EX3210U 4K UHD 32'(81cm) 3840 x 2160 Pixels VESA DisplayHDR600 IPS Gaming Monito\nPrice(Including all inclusive taxes)- Rs 45,329/-Only\n\n");
...
int television()
{
    ...
    case 3:
        ...
        break;
    case 4:
        printf("We Have 3 Models from the brand Samsung /n");
        samsunng();
        break;
    default:
        printf("Invalid Choice !, Enter a number between '1-4'\n");
...
int main()
{
    ...
    printf("\n Your total bill is Rs %d /-",tprize);
